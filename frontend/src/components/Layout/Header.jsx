...
import { Menu, Search, Filter, Plus, Sun, Bell, Settings, ChevronDown, LayoutDashboard, BarChart3, Users, ShoppingBag, MessageSquare }
  from 'lucide-react';
...
const menuItems = [
  ...
  // آپ کی فرمائش کے مطابق نئے آئٹمز
  {
    id: "messages",
    icon: MessageSquare,
    label: "Messages",
    count: "5", // اگر کوئی نئے میسجز دکھانے ہوں
  },
  {
    id: "settings",
    icon: Settings,
